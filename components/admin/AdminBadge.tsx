import type { AdminStatusTone } from '../../lib/admin/types';
...
export default function AdminBadge({ children, tone = 'neutral' }: { children: React.ReactNode; tone?: AdminStatusTone }) {
  return (
