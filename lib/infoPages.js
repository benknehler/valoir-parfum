export const infoPages = {
  ...
  privacy: {
    ...
    details: [
      ...
      ['Sicherheit', 'Zahlungsdaten werden über den angebundenen Zahlungsanbieter Stripe verarbeitet.'],
    ],
  },
  imprint: {
    title: 'Impressum',
    eyebrow: 'Valoir Parfum',
    intro: 'Die vollständigen Betreiberangaben müssen vor dem öffentlichen Verkauf mit den echten Unternehmensdaten ergänzt werden.',
    details: [
      ['Marke', 'Valoir Parfum'],
      ['Kontakt', 'studio@valoir.parfum'],
      ['Pflichtangaben', 'Name, Anschrift, Vertretungsberechtigung, Registerangaben und Umsatzsteuer-ID werden in der Launch-Checkliste geführt.'],
    ],
  },
  terms: {
    title: 'AGB',
    eyebrow: 'Kaufbedingungen',
    intro: 'Die allgemeinen Geschäftsbedingungen müssen vor dem Live-Verkauf rechtlich finalisiert und veröffentlicht werden.',
    details: [
      ['Geltung', 'Die AGB regeln Bestellung, Zahlung, Lieferung und Kundenservice für Valoir Parfum.'],
      ['Prüfung', 'Die finale Fassung muss mit echten Unternehmensdaten und rechtsverbindlichen Bedingungen ergänzt werden.'],
      ['Status', 'Offene Pflichtangaben stehen in LAUNCH_CHECKLIST.md.'],
    ],
  },
  withdrawal: {
    title: 'Widerruf',
    eyebrow: 'Verbraucherrecht',
    intro: 'Die Widerrufsbelehrung muss vor dem Live-Verkauf mit der finalen Anbieteradresse und Rücksendeadresse ergänzt werden.',
    details: [
      ['Frist', 'Verbraucher benötigen eine klare Widerrufsfrist und Rücksendeanleitung.'],
      ['Ausnahme', 'Versiegelte Düfte können nach Entfernung der Versiegelung vom Widerruf ausgeschlossen sein.'],
      ['Status', 'Die finale juristische Prüfung ist Teil der Launch-Checkliste.'],
    ],
  },
};
